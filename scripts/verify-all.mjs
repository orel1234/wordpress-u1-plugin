...
const SUITES = [
  ...
  ['verify-duplicates', ['scripts/verify-duplicates.mjs']],
  ['verify-engines-manual', ['scripts/verify-engines-manual.mjs']],
  ...
  ['verify-patch-focusring', ['scripts/verify-patch-focusring.mjs']],
  ...
  ['verify-scan-static', ['scripts/verify-scan-static.mjs']],
  ['verify-dynamic-scan', ['scripts/verify-dynamic-scan.mjs']],
