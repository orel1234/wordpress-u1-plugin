...
window.u1?.fix.tabs(".finder__tabs", {
  "isVertical": false,
  "selectors": {
    "tabList": ".finder__tabs",
    "tab": ".finder__tab",
    "tabPanel": ".finder__panel"
  }
});
...
window.u1?.fix.accordion(".accordion__trigger", {
  ...
  "selectors": {
    "headerSelector": ".accordion__trigger",
    "contentSelector": ".accordion__panel"
  }
});
}
__u1ApplyMappings();
